...
const UserView = () => {
    ...
    return (
        <div className="container h-screen mx-auto">
            {request && !benefit ? (
                <div className="absolute top-0 left-0 flex overflow-y-scroll no-scrollbar flex-col w-screen h-screen user-requests bg-gradient-to-r from-red-800 to-red-700">
                ...
                <div className="overflow-y-scroll no-scrollbar absolute top-0 left-0 flex flex-col w-screen h-screen px-4 py-4 rounded-md w-90 user-request bg-gradient-to-r from-red-900 to-red-700">
